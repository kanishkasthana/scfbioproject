...
//Updated 16 July
//Updated 18,19,20,21,22,23,26,27,30 July
...
//Part 7:Rotating Second Fragment and checking for clashes
 f1=0;
 f2=0;
 int last_atm,first_atm,clashes1=0,clashes2=0,ang=3,low1=0,pos1=0,low2=0,pos2=0,finalpos=0,finalclashes=0;
 ...
 int j,bendclashes1=0,bendpos1=0,num1=1,num2=1;
 int bendclashes2=bendclashes1,bendpos2=bendpos1,finalbendpos=0,finalbendclashes=0,tweek=3,rotpos1=0,rotpos2=0,finalrotpos=0;
...
if(finalclashes!=0)
{
 ...
 if(replace1<condition || replace2<condition)
 {
...
else
{
 ...
 int num3=1,swingclashes1=0,swingclashes2=0,finalswingclashes=0;low1=0;low2=0;pos1=0;pos2=0;ang=2;
 low1=finalbendclashes;// BE CAREFUL HERE:If num1 lowered too much above it may lead to problems here
 low2=low1;
 swingclashes1=low1;
 swingclashes2=low2;
 cout<<low1<<" 0"<<endl;
